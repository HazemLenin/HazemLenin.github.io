  ...
  experience: [
    {
      ...
      highlights: [
        "Mid-senior developer on GapMap, a modular B2B partition management platform serving enterprise clients — owned the Contractors module end-to-end across .NET Core API and Angular.",
